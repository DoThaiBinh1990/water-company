  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
      <div className="bg-white p-6 rounded-xl shadow-xl mb-6 border border-gray-200">
        <h2 className="text-2xl font-bold text-blue-700 mb-1">Timeline Thi công - Công trình Sửa chữa nhỏ</h2>
        <p className="text-sm text-gray-500 mb-6">Quản lý và theo dõi tiến độ thi công cho các công trình sửa chữa nhỏ.</p>
